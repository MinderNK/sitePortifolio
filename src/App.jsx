...
function App() {
  ...
  const skills = [
    ...
    'PHP', 'MySQL', 'Git', 'Docker', 'AWS', 'Figma', 'RESTful APIs',
    'Bootstrap', 'Tailwind CSS', 'Haskell', 'Vue.js', 'Linux', 'Flutter', 
    'React Native', 'UI/UX Design', 'SEO', 'Accessibility', 'Responsive Design', 'Dart'
  ]
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Serviços contínuos de manutenção, atualizações e melhorias para garantir o desempenho ideal.'
    }
  ]
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto text-muted-foreground">
              Transformo ideias em soluções digitais. Desenvolvimento web e 
              aplicações móveis.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Estudante de Sistemas para Internet (FATEC Santos), com interesse em desenvolvimento web, mobile e inovação digital, 
                  especializo-me em criar aplicações que combinam design moderno 
                  com funcionalidade robusta. Minha paixão é transformar ideias complexas em 
                  soluções simples e eficientes.
                </p>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Estudante em Sistemas para Internet em Fatec Rubens Lara, estou sempre em busca de novas tecnologias 
